			...
			<Grid.Container justify="center">
				<Transition delay={0.8}>
					<Text p>
						...
						in <code>Rust</code>, and I love it for its performance and DX.
						Aside from how I started programming, my pronouns are{' '}
						<code>he/him</code>, and if you want to chat with me, you can send
						me a PM on Twitter{' '}
