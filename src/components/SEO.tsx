...
export default function SEO({ page }: props) {
  return (
    <Head>
      ...
      <link rel="apple-touch-icon" href="https://avatars.githubusercontent.com/u/50248166?v=4" />
      <link
        rel="shortcut icon"
      ...
      <meta name="twitter:image" content="https://avatars.githubusercontent.com/u/50248166?v=4" />
      <meta property="og:site_name" content="Rithul Kamesh's portfolio" />
      <meta property="og:type" content="website" />
      <meta property="og:image" content="https://avatars.githubusercontent.com/u/50248166?v=4" />
